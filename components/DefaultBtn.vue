...
<template>
  <NuxtLink v-if="to" :to="to" :external="isExternal" :target="setTarget" :class="btnCls" class="flex items-center justify-center decoration-none cursor-pointer duration-400">
    <p>{{ text }}</p>
